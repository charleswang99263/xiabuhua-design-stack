# sheet then palette/bands/grounds/wipe/trace with ffprobe/ffmpeg/Pillow/numpy
...
ffprobe duration; ffmpeg extraction; Pillow/numpy sheet, palette, bands, grounds, wipe, trace
...
ffmpeg temp frames are removed by tempfile lifetime; nonzero on ffprobe/decode failure

## 降级

missing ffmpeg/Pillow/numpy or undecodable clip exits; no guessed trajectory

## 输出

sheet writes contact PNG; palette prints dominant/mid greys; bands prints control boxes; grounds prints section transition; wipe prints band profiles; trace prints arc/chord ratios

## 工具输入样本

user-supplied MP4 clip decodable by ffprobe/ffmpeg
...
preserve video evidence before selecting web implementation

## 验收

sheet first; pixel/CSS px and trajectory recorded
...
source clip is fixture; wrong 2x CSS assumption is a local negative fixture
