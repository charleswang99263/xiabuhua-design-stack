...
flat assets with depth

## 路由结果

image-plane scene contract
...
perspective camera + DOM text

## 版式与样式

image-plane scene contract owns its page/component layout before motion
...
occlusion/shadow/mobile fallback
...
先定 asset contract/DOM text，再试 camera/planes
