...
topic or detailed brief

## 路由结果

MOTION_SPEC then build
...
declared page/component layer

## 版式与样式

MOTION_SPEC then build owns its page/component layout before motion

## 状态编排

tracks and milestones in spec
...
先产出 motion/interaction contract，再交 implementation
