...
source layer measured

## 版式与样式

mechanism adaptation owns its page/component layout before motion

## 状态编排

source scroll/pointer/audio behavior
...
把 source mechanism 映射到本地 recipe 并保留差异
