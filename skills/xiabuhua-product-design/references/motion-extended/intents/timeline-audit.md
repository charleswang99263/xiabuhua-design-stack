...
timeline track matrix

## 排除情形

exclude teleport-only proof
...
timeline track matrix owns its page/component layout before motion

## 状态编排

scroll ranges and holds
...
把 tracks 横向铺在同一 scroll axis 查死段
