...
exclude CSS skew equivalence

## 渲染层

canvas/WebGL or measured quad

## 版式与样式

homography lab owns its page/component layout before motion

## 状态编排

pointer/scroll drives corners
...
验证 quad/tilt guard 后才采用 homography
