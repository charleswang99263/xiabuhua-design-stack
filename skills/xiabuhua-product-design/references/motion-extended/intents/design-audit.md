...
looks generated/ugly

## 路由结果

still-frame + slop gate

## 排除情形

exclude spring tuning
...
still-frame + slop gate owns its page/component layout before motion
