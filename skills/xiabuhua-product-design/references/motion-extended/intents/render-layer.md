...
DOM/canvas/WebGL choice

## 路由结果

render layer declaration

## 排除情形

exclude context-only detection
...
render layer declaration owns its page/component layout before motion
...
记录实际 context/program/shape 后锁定 layer
