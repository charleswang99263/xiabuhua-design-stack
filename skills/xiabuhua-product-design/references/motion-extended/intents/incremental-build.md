...
delta motion contract

## 排除情形

exclude unrelated refactor

## 渲染层

preserve host DOM/style

## 版式与样式

delta motion contract owns its page/component layout before motion
