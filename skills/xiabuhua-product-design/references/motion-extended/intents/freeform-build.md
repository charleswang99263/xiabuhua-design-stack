...
exclude generic template

## 渲染层

page stack selected by content

## 版式与样式

creative direction contract owns its page/component layout before motion

## 状态编排

signature mechanism optional
