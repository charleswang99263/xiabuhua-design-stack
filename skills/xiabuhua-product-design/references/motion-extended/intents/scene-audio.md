...
exclude autoplay surprise

## 渲染层

Web Audio/media layer

## 版式与样式

audio bus contract owns its page/component layout before motion

## 状态编排

act curve + gesture event
...
先解决 gesture/consent/bus，再写 REST oracle
