...
reference plus collect as case
...
exclude skin/brand copy

## 渲染层

single-file or declared stack

## 版式与样式

isolated lab case owns its page/component layout before motion

## 状态编排

case oracle schedule
...
执行 strip-images gate、case README 和 domain oracle
