...
WebGL/canvas + text layer

## 版式与样式

ink render experiment owns its page/component layout before motion

## 状态编排

static warp + 11Hz boil
