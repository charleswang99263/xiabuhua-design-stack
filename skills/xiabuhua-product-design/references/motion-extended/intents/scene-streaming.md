...
exclude hidden-only disposal

## 渲染层

canvas/WebGL/DOM resource owner

## 版式与样式

stream lifecycle contract owns its page/component layout before motion

## 状态编排

screen window + cooperative scan
...
create/dispose/cache/visibility
...
按 screen window 建立 create/dispose/cache 生命周期
