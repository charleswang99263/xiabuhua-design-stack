...
```json
{
  ...
  "actual_local_evidence": [
    "xiabuhua-product-design/SKILL.md",
...
topic brief; no reference

## 路由结果

creative landing/portfolio full page

## 排除情形

exclude dashboard/admin/logged-in UI

## 渲染层

creative page stack + authored sections

## 版式与样式

creative landing/portfolio full page owns its page/component layout before motion

## 状态编排

ambient or authored page choreography
...
partial static/reduced page; product route wins
...
选择 blueprint、stack、dialect 后再编排整页
