...
exclude template defaults

## 渲染层

sections, type, grid, mobile

## 版式与样式

visual direction contract owns its page/component layout before motion

## 状态编排

motion follows layout
