...
frame/trajectory measurement

## 排除情形

exclude title-based guess

## 渲染层

media/DOM layer after evidence

## 版式与样式

frame/trajectory measurement owns its page/component layout before motion

## 状态编排

frames define path/timing
