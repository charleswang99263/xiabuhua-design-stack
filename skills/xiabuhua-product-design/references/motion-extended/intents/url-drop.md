...
deconstruction report then clarify build intent

## 排除情形

exclude gallery chrome

## 渲染层

source page layer + measured DOM

## 版式与样式

deconstruction report then clarify build intent owns its page/component layout before motion

## 状态编排

source timing only after inspect
