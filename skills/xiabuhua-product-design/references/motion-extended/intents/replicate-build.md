...
URL plus build request

## 路由结果

adapted page contract

## 排除情形

exclude brand/copy/UI identity

## 渲染层

source layer mapped to local layer

## 版式与样式

adapted page contract owns its page/component layout before motion

## 状态编排

source trigger/timing extracted
...
asset/license and reduced fallback
...
抽取 source geometry/timing 后写适配差异
