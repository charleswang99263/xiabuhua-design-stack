...
specific complaint oracle

## 排除情形

exclude aggregate score
...
specific complaint oracle owns its page/component layout before motion

## 状态编排

pinned clock/real input
