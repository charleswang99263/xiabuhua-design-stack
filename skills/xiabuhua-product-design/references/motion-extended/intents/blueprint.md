...
page blueprint contract

## 排除情形

exclude invented facts

## 渲染层

DOM semantic sections

## 版式与样式

page blueprint contract owns its page/component layout before motion

## 状态编排

none until structure accepted
...
逐 section 写任务/内容/出口并标 invented facts
