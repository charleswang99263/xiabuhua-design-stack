...
asset contract owns its page/component layout before motion

## 状态编排

load/placement metadata
...
逐资产核验 own-background、bbox、density 和 provenance
