...
exclude center-click false pass

## 渲染层

DOM hit regions and painted bbox

## 版式与样式

affordance contract owns its page/component layout before motion
...
用 grid sweep、dwell window 和真实 gesture 查 discoverability
