...
exclude input-independent fake motion

## 渲染层

DOM/canvas based on current layer

## 版式与样式

tactile contract owns its page/component layout before motion

## 状态编排

dt/velocity/spring measured
...
分别测 spring、follow、velocity 和 settle，不混 controller
