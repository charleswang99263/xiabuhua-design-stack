...
spatial scene experiment

## 排除情形

exclude full 3D default

## 渲染层

Gaussian/3D only after capability gap

## 版式与样式

spatial scene experiment owns its page/component layout before motion

## 状态编排

camera path/stream window
