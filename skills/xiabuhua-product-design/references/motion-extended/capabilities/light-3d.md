# Three/R3F 分工、模型交付、environment tint、DOM over scene、亮度 probe
...
Three/R3F canvas with DOM overlay

## 版式与样式

environment tint and coordinates are shared

## 时序与轨道

light/scene loop follows visibility

## 取消与资源管理

dispose model/material/DOM bridge

## 降级

static lighting and readable DOM fallback

## 执行步骤

只列实验目标，不能将 graphics runtime 标为完整 light-3d

## 验收

ownership/dispose/visibility/坐标/亮度可复核
