# strip-images gate、数值拆解、dialect/blueprint/arc/rung、single-file、probe、oracle、README filing
...
```json
{
  ...
  "actual_local_evidence": [
    "xiabuhua-product-design/references/executor-handoff.md",
    "xiabuhua-product-design/references/design-qa-checklist.md"
  ],
  "runtime_required": "handoff + QA",
...
single-file case or declared rung

## 版式与样式

case README owns design/motion/oracle layout

## 时序与轨道

case schedule and constants are source facts

## 取消与资源管理

real input path and teardown required

## 降级

whole page designed fallback

## 执行步骤

只借流程和字段，禁止安装/复制上游 case

## 验收

设计/动效/判据/边界/踩坑/改造方向齐全
