...
continuous low-level loop; foreground stable

## 轨道

ambient layer only; content track independent
...
pause offscreen/hidden; reduced freezes environment

## 执行步骤

把环境 loop 与前景信息隔离并按可见性暂停
