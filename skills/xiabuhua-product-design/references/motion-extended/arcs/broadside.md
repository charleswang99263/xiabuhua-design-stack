...
page scroll/step or ambient clock as declared
...
hero pinned/scrubbed then late breath

## 轨道

tracks: impact→held pressure→release
...
interruptible; pause offscreen/hidden; reduced/static end

## 本地扩展

reduced keeps hierarchy without sustained parallax

## 执行步骤

将 hero impact 与 pinned pressure 绑定，再留 late breath

## 验收

arc rhythm and tracks are visible in a sampled timeline; no dead/overlapping beat
