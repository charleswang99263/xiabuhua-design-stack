...
~0.04s stagger groups; short beats

## 轨道

bounded visible group, no screenful fade

## 转换节奏

tight stagger; no input lock
...
reduced commits all labels immediately

## 执行步骤

用短 stagger 表达数据节奏，限制并发和输入锁
