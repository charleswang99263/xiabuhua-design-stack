...
```json
{
  ...
  "runtime_required": "museum Metric Pulse",
...
number is data truth; scroll trigger only starts decorative interpolation
...
counter 0→target over 1.4s power2.out; once at top 85%; decimals/prefix/suffix preserved
...
interpolate truthful number without delaying commit

## 验收

truthful commit; decorative timing
