...
```json
{
  ...
  "runtime_required": "new homography lab",
...
corner positions from drag/scroll
...
DOM remains selectable; quad guard, edge clamp, image 1×/backface hidden; WebGL past16 slices
...
one matrix3d for convex quad; CSS round-trip floor .016px; tilt max asin(h/w)×.85; ~8 slices for curved edge
...
compute guarded homography and clamp edge tilt

## 验收

convex quad; edge clamp; fallback
