...
```json
{
  ...
  "runtime_required": "graphics/filter contract",
...
pointer drag/hover across mask
...
SVG mask reveals second layer; reduced snaps mask or fixed low opacity
...
6-point leader/follower .12 then .19−i×.014; blur22; color matrix 22 −9; radius grows with speed
...
blur follower points into a mask for alternate layer

## 验收

filter failure + DOM fallback
