...
```json
{
  ...
  "runtime_required": "interaction edge contract",
...
route key owns transition; no simultaneous page collision; fallback immediate
...
Framer initial y16 opacity0; enter .45s y0; exit .25s y−8; mode wait
...
wait for exit before enter and preserve route state

## 验收

state/focus/return context
