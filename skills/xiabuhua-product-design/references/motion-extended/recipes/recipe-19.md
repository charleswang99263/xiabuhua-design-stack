# Slack String Between Anchor and Datum
...
```json
{
  ...
  "runtime_required": "new slack-string lab",
...
datum/clock or gauge target plus drag
...
exact anchor/datum plus soft sag; box clamp then reach; reduced quadratic rest shape
...
tip stiff K1600 example; body 3 iterations×.5; fixed dt1/120; cap sweep forward/back twice; rest arc measured
...
hold exact endpoints while soft body sags
