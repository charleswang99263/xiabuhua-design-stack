...
```json
{
  ...
  "runtime_required": "new card-chain lab",
...
pointer head movement for chain
...
pointer head drives Verlet card chain and normals; cancel/dispose/accessibility required
...
N7; REST118; CARD190×84; gravity.55; damping.965; 16 iterations; pinned share1.0; degenerate0 oracle
...
solve pinned Verlet chain then corner-pin cards

## 验收

stable identity/cancel/dispose/list
