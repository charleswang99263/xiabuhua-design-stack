...
```json
{
  ...
  "runtime_required": "scroll owner contract",
...
one clock/scroll owner; cleanup off/destroy; native/local scroll fallback
...
Lenis lerp .085; GSAP ticker drives raf; update on Lenis scroll; lagSmoothing(0)
...
wire Lenis to the single GSAP ticker and destroy

## 验收

one scroll owner; cleanup
