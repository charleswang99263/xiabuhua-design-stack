...
```json
{
  ...
  "runtime_required": "interaction pattern contract",
...
scroll exposes section under header
...
class allowlist for static dark; computed style for animated background; theme commits once
...
fixed header probes y38; computed luminance threshold145; scroll plus two-RAF delayed recheck
...
choose static class or live luminance probe for theme

## 验收

theme commit/contrast/rapid toggle
