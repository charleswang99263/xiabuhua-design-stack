...
```json
{
  ...
  "runtime_required": "tactile input/focus",
...
document mousemove and hover enter/leave
...
fixed pointer-events-none cursor; coarse pointer hides it, system cursor remains
...
document mousemove target; follower per-frame .12; cursor 24→48px hover expansion
...
follow pointer and morph cursor only on fine pointer
