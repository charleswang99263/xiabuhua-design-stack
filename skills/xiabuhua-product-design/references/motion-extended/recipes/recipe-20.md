...
```json
{
  ...
  "runtime_required": "bounded emergence lab",
...
screen window/dealing clock; new card above old; static/reduced keeps count and foreground
...
TICK167ms; skip 1/2/3; arrivals are one-frame hard placement; CAP46 live vs dealt count; z by arrival
...
deal hard one-frame cards on measured tick grid

## 验收

seed/DOM cap/foreground/reduced
