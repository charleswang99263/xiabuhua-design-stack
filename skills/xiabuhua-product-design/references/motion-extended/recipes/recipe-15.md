...
```json
{
  ...
  "runtime_required": "new cloth lab",
...
pointer repulsion plus wheel energy
...
independent vertical columns; IntersectionObserver rootMargin80; reduced analytical rest shape
...
5 Verlet passes; anchor return .35; Y repulsion×.35; falloff (1−d/70)^2×4.2; scroll energy decay .97
...
solve independent columns and store scroll energy

## 验收

real split/rest constraints/DOM fallback
