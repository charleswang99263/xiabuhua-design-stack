...
```json
{
  ...
  "runtime_required": "tactile hysteresis contract",
...
mousemove within element radius
...
button/icon follows pointer within radius; reduced removes translate, keeps color
...
mousemove offset × strength .35/.4; enter 0.1s linear; leave 0.5s cubic return
...
apply bounded attraction then spring return

## 验收

thresholds; keyboard; hitbox unchanged
