...
```json
{
  ...
  "runtime_required": "tactile parallax",
...
absolute depth layers inside relative container; no clipping on travel
...
scrollY× speeds .2/.5/.8 in one RAF; each layer has overflow/extra extent
...
write three depth gains from one scroll source

## 验收

pointer/touch/keyboard; bounded depth
