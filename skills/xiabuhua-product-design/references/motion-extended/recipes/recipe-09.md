...
```json
{
  ...
  "runtime_required": "museum Sticky Step Reveal",
...
scroll drives labelled steps; mobile replaces pin with vertical stack
...
pin top top; end +=200%; scrub 1.5; step transitions with +=.3
...
scrub labelled steps over pin window

## 验收

real scroll/step; reduced linear
