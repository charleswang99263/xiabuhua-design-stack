...
static pose at uStep0; reduced hides none; DOM state mirrors canvas

## 渲染机制

WebGL2; 620 instances; 4 shader programs; MRT + depth discontinuity line
...
pointer ray aims at projected crowd; 11Hz boil against 60fps render
...
4 programs/resources require visibility pause and GPU dispose

## 本地扩展

conditional WebGL case

## 执行步骤

先验证 WebGL layer/program/depth oracle，再决定 graphics lab

## 验收

layer/program/resource probe + DOM/SVG text + DPR/visibility
