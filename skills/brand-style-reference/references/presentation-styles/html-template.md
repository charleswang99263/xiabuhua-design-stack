...
Reference architecture for generating slide presentations. Every presentation follows a fixed 16:9 stage model: slides are authored at 1920×1080 and the whole stage scales to fit the browser window. This file is an implementation reference; an approved/inherited style agreement and selected specimen own the visual direction.

The `--project-*` properties below are intentional binding slots, not a runnable theme. Define every used slot from the selected specimen before delivery; use a declared static treatment when motion is absent. Verify computed styles and fonts in the final deck. Do not ship unresolved slots.
...
<head>
    ...
    <!-- Load only the font resources selected in the style agreement. Local/system fonts need no remote link. -->
    ...
    <style>
        /* ===========================================
           ...
           =========================================== */
        :root {
            /* Colors — from the approved/inherited style agreement */
            --bg-primary: var(--project-canvas);
            --bg-secondary: var(--project-surface);
            --text-primary: var(--project-ink);
            --text-secondary: var(--project-muted);
            --accent: var(--project-accent);
            --accent-glow: var(--project-accent-treatment, transparent);

            /* Typography — from the agreement, authored at 1920×1080 stage size */
            --font-display: var(--project-display-font);
            --font-body: var(--project-body-font);
            --title-size: var(--project-display-size);
            --subtitle-size: var(--project-subtitle-size);
            --body-size: var(--project-body-size);

            /* Spacing — authored at 1920×1080 stage size */
            --slide-padding: var(--project-slide-padding);
            --content-gap: var(--project-content-gap);

            /* Animation */
            --ease-out-expo: cubic-bezier(0.16, 1, 0.3, 1);
            --duration-normal: var(--project-motion-duration, 0s);
        }
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --- PASTE ../../../html-deck-runtime/viewport-base.css CONTENTS HERE --- */
        ...
        .reveal {
            opacity: 0;
            transform: translateY(var(--project-enter-distance, 0px));
...
- `prefers-reduced-motion` support (provided by the html-deck-runtime execution CSS)
