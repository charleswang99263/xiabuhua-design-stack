...
> 迁移说明：以下内容中的参数、颜色、字体、间距与命令式写法均为示例值，不构成项目默认、冻结规则或执行指令。
...
### HTML Deck Runtime Integration Note

When using this design system inside the `html-deck-runtime` skill, preserve the
